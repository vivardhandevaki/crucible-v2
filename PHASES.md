...
| 3 | Real adapter: conformance fixtures (Maven+Gradle) → `java-junit`; stub retired to conformance suite | `design/phase-3.md` **(DRAFT — re-ratify via P3-00 after P2 green)** | `tasks/phase-3.md` **(DRAFT)** | Conformance passes; hello-world Spring Boot change flows end-to-end | ☐ ready — Phase 2 green; begins at P3-00 re-ratification |
