...
| 2 | Deepen the loop: full lint, tiers, amend/override/escalate, change types, reviewer + rubric, trajectory capture, notify, why, doctor, approve surface | `design/phase-2.md` (ratified via P2-00, 2026-07-24) | `tasks/phase-2.md` | All three charter worked-example flows executable on toy repo | ◐ in progress (P2-00..11, P2-14..15, P2-18 done; P2-12..13, P2-16..17 open) |
