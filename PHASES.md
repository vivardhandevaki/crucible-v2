...
| 3 | Real adapter: conformance fixtures (Maven+Gradle) → `java-junit`; stub retired to conformance suite | `design/phase-3.md` (ratified via P3-00, 2026-07-29) | `tasks/phase-3.md` | Conformance passes; hello-world Spring Boot change flows end-to-end | ☐ in progress — P3-00..05 and P3-10 complete; P3-06 is next |
