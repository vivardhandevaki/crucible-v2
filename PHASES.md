...
| 2 | Deepen the loop: full lint, tiers, amend/override/escalate, change types, reviewer + rubric, trajectory capture, notify, why, doctor, approve surface | `design/phase-2.md` **(DRAFT — re-ratify via P2-00 after P1 green)** | `tasks/phase-2.md` **(DRAFT)** | All three charter worked-example flows executable on toy repo | ☐ blocked on Phase 1 |
