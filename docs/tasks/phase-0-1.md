...
Format: each task is one focused session. **Done = the named acceptance tests pass + committed.** Tests are written failing before implementation (AGENTS.md test-first rule). `Reads:` is the session's required context. Tier: Fable / Sol = design/judgment-heavy; Opus / Terra = well-specified implementation.

---

## Phase 0

**P0-01 · OpenSpec spike** · Tier: Fable / Sol · Depends: —
...
**P0-02 · Monorepo scaffold** · Tier: Opus / Terra · Depends: P0-01
Reads: architecture.md §1, §9; AGENTS.md build decisions.
...
**P0-03 · Toy fixture repo** · Tier: Opus / Terra · Depends: P0-02
...
**P1-02 · Config loaders** · Tier: Opus / Terra · Depends: P1-01
...
**P1-03 · Oracle parser** · Tier: Opus / Terra · Depends: P1-01
...
**P1-04 · Spec-delta REQ extractor** · Tier: Opus / Terra · Depends: P1-01
...
**P1-05 · Traceability lint v0** · Tier: Opus / Terra · Depends: P1-03, P1-04
...
**P1-06 · Hash module & approval.yaml** · Tier: Opus / Terra · Depends: P1-03
...
**P1-07 · approve command** · Tier: Opus / Terra · Depends: P1-05, P1-06
...
**P1-08 · AgentSubstrate + ClaudeCode + Fake** · Tier: Fable / Sol (interface freeze) then Opus / Terra (impl) · Depends: P1-01
...
**P1-09 · propose command + propose role prompt** · Tier: Fable / Sol · Depends: P1-03..05, P1-08
...
**P1-10 · Stub adapter** · Tier: Opus / Terra · Depends: P0-03
...
**P1-11 · Adapter client** · Tier: Opus / Terra · Depends: P1-10
Reads: same as P1-10.
...
**P1-12 · verify command** · Tier: Opus / Terra · Depends: P1-05, P1-06, P1-11
...
**P1-13 · implement command** · Tier: Opus / Terra · Depends: P1-07, P1-08, P1-12
...
**P1-14 · status command** · Tier: Opus / Terra · Depends: P1-06, P1-12
...
**P1-15 · CI template** · Tier: Opus / Terra · Depends: P1-12
...
**P1-16 · Tracer integration test** · Tier: Fable / Sol · Depends: all P1
